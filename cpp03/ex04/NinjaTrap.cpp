...
/*   Updated: 2020/03/03 13:06:09 by trbonnes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned		NinjaTrap::baseMaxHitPoints() const{
	return 60;
}
...
unsigned		NinjaTrap::baseMaxEnergyPoints() const{
	return 120;
}

unsigned		NinjaTrap::baseLevel() const{
	return 1;
}

unsigned		NinjaTrap::baseMeleeAttackDamage() const{
	return 60;
}

unsigned		NinjaTrap::baseRangedAttackDamage() const{
	return 5;
}

unsigned		NinjaTrap::baseArmorDamageReduction() const{
	return 0;
}
